...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
				<h4  class="bg-info">		${linkstring }</h4>
				</div>
				</div>
				</div>
					<section>
						<ul id="da-thumbs" class="da-thumbs">
						<c:forEach var="v" items="${sectorlist}"> 
							<li>
								<a  href="subsector_tour.do?linkhomeid=${v.homeid}" class="b-link-stripe b-animate-go thickbox">
