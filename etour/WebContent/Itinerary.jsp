...
<ul class="nav nav-tabs">
		<li class="active" ><a href="iternaryFetch.do?linktourid=${tid}">Itinerary</a></li>
		<li><a href="costfetch.do?linktourid=${tid}">Cost</a></li>
						...
						<ul id="da-thumbs" class="da-thumbs">
							...
							<li>
								<a  class="b-link-stripe b-animate-go thickbox">
									<img src="${list[0].tourref.imagepath } "  alt="" />
									<div>
										<h5> ${list[0].tourref.tourname }</h5>
									</div>
								</a>
							</li>
...
<table border="1" class="table table-hover" >
 <tr>
                       ...
                       <td><h4>DAY ${temp.daynumber}</h4></td>
                    
                     <td><h4>::${temp.daysdescription}</h4></td>
                       
 </tr>
  </table>
 </c:forEach></div><div class="col-sm-1 "></div>
